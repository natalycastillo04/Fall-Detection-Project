/*
   ...
   (Modified for Arduino UNO R4 WiFi: renamed MPU -> MPU_ADDR to avoid
   colliding with the Renesas core's MPU register macro)
*/
#include <Wire.h>
...
void setup() {
  ...
  Wire.beginTransmission(MPU_ADDR);  // Start communication with MPU6050 // MPU_ADDR=0x68
