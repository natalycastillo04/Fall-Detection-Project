...
void neopixelStick(int lightLevel, float distance)
{
  // Motion detected: flash red and buzz
  ...
  // Motion stopped: make sure buzzer is off
  noTone(buzzerPin);

  // Dark: solid white LEDs
